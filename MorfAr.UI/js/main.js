...
function doSearch(){
    ...
    var results = $.getJSON(searchUrl, function (data) {
        ...
        $.each(data, function (i) {
            ...
            $(".container.accordion").append('<div class="accordion-section"><a class="accordion-section-title" href="#accordion-'+i+'">'+currentResult.itemName+'</a> <div id="accordion-'+i+'" class="accordion-section-content open"> <div class="row"> <div class="col-md-6"> <p class="place">'+currentResult.place.placeName+'</p> <p class="adress">Pellegrini: 1234</p> <p class="delivery">¿Tiene delivery?: '+haveDelivery+'</p> <p class="delivery">¿Tiene para llevar?: '+haveTakeAway+'</p> <p class="score">8 puntos</p> </div> <div class="col-md-6"><img class="food-img" src="'+currentResult.itemUrlPhoto+'"></img> </div> </div> <div class="row"> <div class="col-md-6"> <div class="col-md-12">  <div>'+currentResult.place.googleMapsUrl+'</div> </div> </div> <div class="col-md-6"> <p class="score">Comentarios</p> <ul id="comments"></ul> </div> </div>');
